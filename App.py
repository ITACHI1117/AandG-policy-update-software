...
def run_program():
    ...
    regNchassis_policy_number.grid(row=2, column=2, padx=10, pady=10, sticky="")
    regNchassis_policy_number_textbox = tb.Entry(f2, width=30, )
    regNchassis_policy_number_textbox.grid(row=2, column=3, padx=(10, 20), pady=(10, 20), sticky="nsew")

    regNchassis_reg_number = tb.Label(master=f2, text="Reg Number")
    regNchassis_reg_number.grid(row=3, column=2, padx=10, pady=10, sticky="")
    regNchassis_reg_number_textbox = tb.Entry(f2, width=30)
    regNchassis_reg_number_textbox.grid(row=3, column=3, padx=(10, 20), pady=(10, 10), sticky="nsew")

    regNchassis_chassis_number = tb.Label(master=f2, text="Chassis Number")
    regNchassis_chassis_number.grid(row=4, column=2, padx=10, pady=10, sticky="")
    regNchassis_chassis_number_textbox = tb.Entry(f2, width=30)
    regNchassis_chassis_number_textbox.grid(row=4, column=3, padx=(10, 20), pady=(10, 10), sticky="nsew")
